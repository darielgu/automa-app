...
| File | Purpose |
|---|---|
| `migrations/0001_job_feed_schema.sql` | `job_listings`, `scrape_runs`, `scrape_source_state`, indexes, and RLS |
| `migrations/0002_job_feed_functions.sql` | Bulk upsert, ETag touch, removal sweep, and the public search function |
| `migrations/0003_job_feed_cron.sql` | Hourly `pg_cron` schedule, staggered per feed |
